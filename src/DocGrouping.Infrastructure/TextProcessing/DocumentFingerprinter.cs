...
public class DocumentFingerprinter
{
	...
	/// <summary>
	/// Fast Jaccard estimate from two MinHash signatures — O(numHashes) integer comparisons.
	/// Use as a pre-filter before loading full text for exact Jaccard verification.
	/// </summary>
	public double EstimateJaccardFromMinHash(int[] sig1, int[] sig2)
	{
